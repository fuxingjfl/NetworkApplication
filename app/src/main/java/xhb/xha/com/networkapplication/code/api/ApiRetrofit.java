...
import xhb.xha.com.networkapplication.utils.NetWorkUtils;
...
public class ApiRetrofit {
    ...
    private Interceptor mCacheInterceptor = chain -> {
        ...
        if (!NetWorkUtils.isNetworkAvailable(Mpp.getContext())) {
...
//    };
    ...
    public ApiRetrofit() {
        //cache url
        File httpCacheDirectory = new File(Mpp.getContext().getCacheDir(), "responses");
